...
locals {
  ...
  keyvaults       = data.terraform_remote_state.remote[var.landingzone.global_settings_key].outputs.objects[var.landingzone.global_settings_key].keyvaults
  vnets           = try(data.terraform_remote_state.remote[var.landingzone.global_settings_key].outputs.objects[var.landingzone.global_settings_key].vnets, {})
  ...
  es_tags                           = merge(var.configure_management_resources.tags, merge(local.landingzone_tag, { "level" = var.landingzone.level }, { "environment" = local.global_settings.environment }, { "rover_version" = var.rover_version }))
  es_configure_management_resources = merge(var.configure_management_resources, { tags = local.es_tags })
