...
locals {
  computed_tag = {
    "DeploymentDate" = true  ##### UTC Time stamped 
  }
  
  tags = merge(try(local.global_settings.tags, {}), local.computed_tag,var.tags)
  ...
  diagnostics = {
    ...
    diagnostics_definition = merge(
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.diagnostics.diagnostics_definition, null),
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.objects[var.landingzone.diagnostics_settings_key].diagnostics.diagnostics_definition, null),
    ...
    diagnostics_destinations = {
      event_hub_namespaces = merge(
        try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.diagnostics.diagnostics_destinations.event_hub_namespaces, {}),
        try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.objects[var.landingzone.diagnostics_settings_key].diagnostics.diagnostics_destinations.event_hub_namespaces, null),
      ...
      log_analytics = merge(
        try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.diagnostics.diagnostics_destinations.log_analytics, {}),
        try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.objects[var.landingzone.diagnostics_settings_key].diagnostics.diagnostics_destinations.log_analytics, null),
      ...
      storage = merge(
        try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.diagnostics.diagnostics_destinations.storage, {}),
        try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.objects[var.landingzone.diagnostics_settings_key].diagnostics.diagnostics_destinations.storage, null),
    ...
    storage_accounts = coalesce(
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.diagnostics.storage_accounts, null),
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.objects[var.landingzone.diagnostics_settings_key].diagnostics.storage_accounts, null),
      ...
      try(var.diagnostics_destinations.storage_accounts, {})
    )

    log_analytics = coalesce(
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.diagnostics.log_analytics, null),
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.objects[var.landingzone.diagnostics_settings_key].diagnostics.log_analytics, null),
    ...
    event_hub_namespaces = coalesce(
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.diagnostics.event_hub_namespaces, null),
      try(data.terraform_remote_state.remote[var.landingzone.diagnostics_settings_key].outputs.objects[var.landingzone.diagnostics_settings_key].diagnostics.event_hub_namespaces, null),
