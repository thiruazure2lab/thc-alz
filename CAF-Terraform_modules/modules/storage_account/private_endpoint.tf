module "private_endpoint" {
  ...
  location            = try(var.global_settings.regions[try(each.value.region, var.global_settings.default_region)],var.resource_groups[each.value.resource_group_key].location)
